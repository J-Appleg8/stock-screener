...
const NavBar = () => (
  <nav
    className={`${inter.variable} border-gray-200  bg-white font-sans dark:bg-gray-900`}
  >
    <div className="mx-auto flex max-w-screen-xl flex-wrap items-center justify-end p-4">
      <div className="w-full md:block md:w-auto" id="navbar-default">
        <ul className="mt-4 flex items-center rounded-lg border border-gray-100 bg-gray-50 p-4 font-medium md:mt-0 md:flex-row md:space-x-8 md:border-0 md:bg-white md:p-0 rtl:space-x-reverse dark:border-gray-700 dark:bg-gray-800 md:dark:bg-gray-900">
          <li>
            <a
              href="#"
          ...
          <li>
            <a
              href="https://github.com/J-Appleg8"
              className="block rounded px-3 py-2 text-gray-900 hover:bg-gray-100 md:border-0 md:p-0 md:hover:bg-transparent md:hover:text-blue-700 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent md:dark:hover:text-blue-500"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 98 96"
                className="h-9 w-9 fill-slate-900 py-1"
              >
                <title>GitHub</title>
